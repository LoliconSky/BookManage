        ...
        <div class="row">
            <div class="col-md-2">
                ...
                <div id="left" class="list-group">
                    <a href="welcome.jsp" target="et" class="list-group-item active" onclick="change(this)">书籍管理系统</a>

                    <a href="addca.jsp" target="et" class="list-group-item" onclick="change(this)">添加类别</a>
                    <a href="addbook.jsp" target="et" class="list-group-item" onclick="change(this)">添加书籍</a>
                    <a href="booklist.jsp" target="et" class="list-group-item" onclick="change(this)">书籍列表</a>
                </div>
            </div>
            <div class="col-md-10">
